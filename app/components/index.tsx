...
const Main: FC<IMainProps> = () => {
  ...
  return (
    <div
      className={`h-full w-full flex bg-white undefined false ${
        isMobile && "flex-col"
      }`}
    >
      {isMobile && (
      ...
      <div className="h-full w-full flex rounded-t-2xl bg-white overflow-hidden">
        ...
        {/* main */}
        <div
          className={`w-full grow overflow-hidden ${"flex items-center justify-center"}`}
        >
              ...
              {hasSetInputs ? (
                <>
                  ...
                  >
                    ...
                    <div
                      className="px-8 mx-auto pt-6 w-full max-w-[720px] false"
                      ref={chatListDomRef}
                    >
                      <Chat
                        chatList={chatList}
